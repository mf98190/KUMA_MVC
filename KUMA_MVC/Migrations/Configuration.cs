namespace KUMA_MVC.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<KUMA_MVC.Models.KumaModel>
    {
        ...
        protected override void Seed(KUMA_MVC.Models.KumaModel context)
        {
            ...
            context.Suppliers.AddOrUpdate(
                x => x.SupplierID,
                new Supplier() { SupplierID = 1, SupplierName = "Supplier1", Phone = "0988789654" },
                new Supplier() { SupplierID = 2, SupplierName = "Supplier2", Phone = "0977546412" },
                new Supplier() { SupplierID = 3, SupplierName = "Supplier3", Phone = "0999654123" },
                new Supplier() { SupplierID = 4, SupplierName = "Supplier4", Phone = "0944125874" },
                new Supplier() { SupplierID = 5, SupplierName = "Supplier5", Phone = "0922100252" },
                new Supplier() { SupplierID = 6, SupplierName = "Supplier6", Phone = "0998756423" },
                new Supplier() { SupplierID = 7, SupplierName = "Supplier7", Phone = "0999654414" }
            );
            context.Products.AddOrUpdate(
                x => x.ProductID,
                new Product() { ProductID = 1, ProductName = "細珠純銀手鍊", CategoryID = 1, UnitPrice = 1250, SupplierID = 1 },
                new Product() { ProductID = 2, ProductName = "鋯石純銀耳扣", CategoryID = 2, UnitPrice = 1580, SupplierID = 2 },
                new Product() { ProductID = 3, ProductName = "細珠層次純銀項鍊", CategoryID = 3, UnitPrice = 2250, SupplierID = 7 },
                new Product() { ProductID = 4, ProductName = "八芒星圖章純銀尾戒", CategoryID = 4, UnitPrice = 1700, SupplierID = 6 },
                new Product() { ProductID = 5, ProductName = "鋯石C字戒指", CategoryID = 4, UnitPrice = 900, SupplierID = 1 },
                new Product() { ProductID = 6, ProductName = "雙圈純銀戒指", CategoryID = 4, UnitPrice = 1800, SupplierID = 1 },
                new Product() { ProductID = 7, ProductName = "ESSENTIAL DOUBLE LAYER RING(3MM)", CategoryID = 4, UnitPrice = 2200, SupplierID = 1 },
                new Product() { ProductID = 8, ProductName = "LOVE字樣戒指", CategoryID = 4, UnitPrice = 2050, SupplierID = 4 },
                new Product() { ProductID = 9, ProductName = "BAE字樣戒指", CategoryID = 4, UnitPrice = 2050, SupplierID = 5 },
                new Product() { ProductID = 10, ProductName = "LOVE字樣戒指", CategoryID = 4, UnitPrice = 2050, SupplierID = 4 },
                new Product() { ProductID = 11, ProductName = "BAE字樣戒指", CategoryID = 4, UnitPrice = 2050, SupplierID = 5 },
                new Product() { ProductID = 12, ProductName = "CHINESE \"發\" NECKLACE", CategoryID = 3, UnitPrice = 1880, SupplierID = 6 },
                new Product() { ProductID = 13, ProductName = "CHINESE \"喜\" NECKLACE", CategoryID = 3, UnitPrice = 1880, SupplierID = 6 },
                new Product() { ProductID = 14, ProductName = "CHINESE \" 福 \" NECKLACE", CategoryID = 3, UnitPrice = 1880, SupplierID = 6 },
                new Product() { ProductID = 15, ProductName = "經典開口設計手環", CategoryID = 1, UnitPrice = 3300, SupplierID = 1 },
                new Product() { ProductID = 16, ProductName = "金屬純銀耳扣", CategoryID = 2, UnitPrice = 1180, SupplierID = 2 },
                new Product() { ProductID = 17, ProductName = "雙圈閃耀細錐純銀手鍊", CategoryID = 1, UnitPrice = 1800, SupplierID = 1 },
                new Product() { ProductID = 18, ProductName = "細珠層次純銀手鍊", CategoryID = 1, UnitPrice = 1850, SupplierID = 3 },
                new Product() { ProductID = 19, ProductName = "八芒星圓片吊飾純銀項鍊", CategoryID = 3, UnitPrice = 3050, SupplierID = 4 },
                new Product() { ProductID = 20, ProductName = "五顆鋯石戒指", CategoryID = 4, UnitPrice = 1100, SupplierID = 7 },
                new Product() { ProductID = 21, ProductName = "LOVE字樣項鍊", CategoryID = 3, UnitPrice = 2600, SupplierID = 4 }
            ...
            context.Status.AddOrUpdate(
                x => x.StasusID,
                new Status() { StasusID = 1, StatusName = "理貨中" },
                new Status() { StasusID = 2, StatusName = "運送中" },
            ...
            context.SupportCategories.AddOrUpdate(
                ...
                new SupportCategory() { SupportCategoryID = 1, SupportCategoryName = "商品詢問" },
